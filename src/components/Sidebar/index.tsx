    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          >
            <path d="M3 2h16a1 1 0 0 1 1 1v11.126A6.477 6.477 0 0 0 14.5 13a6.5 6.5 0 0 0-5.5 10H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z"></path>
            <path d="M3 16h5.5"></path>
            <path d="M8 12H3"></path>
            <path d="M21 21l-3-3"></path>
            <circle cx="15.5" cy="17.5" r="3.5"></circle>
          </svg>
        ),
        label: "Search Courses",
        route: "/dashboard/searchcourses",
      },
      {
        icon: (
          <svg
        ...
        label: "URM University",
        route: "/dashboard/urmuniversity",
      },
      {
        icon: (
          <svg
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 xl:py-10">
          <Link href="/dashboard">
            <Image
              width={176}
              height={32}
              src={"/images/edu1-removebg-preview-2.png"}
              alt="Logo"
              priority
